...
| 6 | **commands → skills migration** — Anthropic now recommends `skills/` over the legacy `commands/` for plugins | [plugins docs](https://platform.claude.com/docs/en/agent-sdk/plugins) (verify live before migrating) | `.claude/commands/` |
