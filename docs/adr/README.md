...
| [ADR-012](ADR-012-persona-layer.md) | The persona layer - named specialists, their cost, and the identity requirement underneath | Proposed | The named roster's real benefits and its three costs (the decay hook, name drift, four roster defect codes) set against the AI-identity requirement underneath; three options put to the human approver, no decision taken. |
