...
- **Test gaming** - tests that special-case known inputs, memorise expected outputs, assert on
  implementation detail, or were weakened until they passed. Logic that only recognises its own
  fixtures is a **missed alert wearing a passing test**.
