...
"why this matters". Drive `bandit`/`gitleaks`/`find-sec-bugs` where available and cite the rule
(`semgrep`/`pip-audit` deliberately excluded - see `code-reviewer.md` for why). Defer the §4/§5
