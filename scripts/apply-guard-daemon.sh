...
echo ""
echo "Still off by default. Turn it on for a project via /preferences (or the installer's"
echo "Advanced menu) once you're ready to actually use it - applying this script alone"
echo "changes nothing live."
