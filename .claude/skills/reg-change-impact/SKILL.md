...
Under the PM (CLAUDE.md §6), drive **business-analyst** (with the matching **`docs/sme/` pack** read in-line for the
...
1. **Understand the change** - what obligation changed, effective date, the new/amended
   requirement (read it against the matching `docs/sme/` pack; don't interpret regulation unaided). **Ground every
