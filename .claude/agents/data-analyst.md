...
When invoked:
1. Clarify the question (e.g. "why is scenario X producing too many alerts?"). Code/file scope comes from the dispatch brief (file list + the codebase map's path when one exists) - never enumerate the repository yourself.
